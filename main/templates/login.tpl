...
<div class="container">
	<div class='jumbotron'>
		<form method='POST' action='/login.php'>
			...
			<div class='row roundedRectangle'>
				<input name="username" type="text" placeholder="請輸入帳號"/>
			</div>
			<div class='row'>
				<input name="password" type="text" placeholder="請輸入密碼"/></div>
			<div class='row'>
				...
				<div class="col-6" style="text-align: center;">
					<button type='submit' style='width: 100%' class='btn btn-dark btn-lg'>登入</button>
				</div>
