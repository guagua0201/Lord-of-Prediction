...
<div class='container'>
	...
	<p>非常歡迎您光臨「預言王」（以下簡稱本網站），為了讓您能夠安心的使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：</p>
	...
	<hr>
	<blockquote>
	<p>基礎資料來源: <a href="http://www.webguide.nat.gov.tw/index.php/ch/speci/index.html" rel="nofollow">《政府網站版型與內容管理規範》</a></p>
	</blockquote>
	</article>
</div>
{/block}