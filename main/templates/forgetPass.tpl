			...
			<div class='row'>
				<div class='input-group input-group-lg'>
					...
					<div class='input-group-append'>
						<button type='button' class='btn btn-lg btn-outline-dark' onclick='forgetPass()'>送出</button>
					</div>
				</div>
				<div id='exist-email' class='text-center text-danger' style='display: none'>
					 此信箱名稱不存在
				</div>
				<div id='alert-email' class='w-100 alert alert-danger alert-dismissable' style='display: none'>
