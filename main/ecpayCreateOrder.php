...
//載入SDK(路徑可依系統規劃自行調整)
include('ECPay/sdk/ECPay.Payment.Integration.php');
try {
    ...
    $obj->Send['TradeDesc']         = "prophecyking coins" ;                          //交易描述
    $obj->Send['ChoosePayment']     = ECPay_PaymentMethod::Credit ;              //付款方式:Credit
    $obj->Send['IgnorePayment']     = ECPay_PaymentMethod::GooglePay ;           //不使用付款方式:GooglePay

    $obj->Send['PaymentType'] = 'aio';
    $obj->Send['ItemName'] = '虛擬幣';



    //訂單的商品資料
    array_push($obj->Send['Items'], array('Name' => "預言王虛擬幣", 'Price' => (int)($_POST['price']),
